...
const APPLICATION_FLAGS: Flag[] = [
    { flag: "GATEWAY_PRESENCE", bitwise: 1 << 12 },
    { flag: "GATEWAY_PRESENCE_LIMITED", bitwise: 1 << 13 },
    { flag: "GATEWAY_GUILD_MEMBERS", bitwise: 1 << 14 },
    { flag: "GATEWAY_GUILD_MEMBERS_LIMITED", bitwise: 1 << 15 },
    { flag: "VERIFICATION_PENDING_GUILD_LIMIT", bitwise: 1 << 16 },
    { flag: "EMBEDDED", bitwise: 1 << 17 },
    { flag: "GATEWAY_MESSAGE_CONTENT", bitwise: 1 << 18 },
    { flag: "GATEWAY_MESSAGE_CONTENT_LIMITED", bitwise: 1 << 19 },
    { flag: "APPLICATION_COMMAND_BADGE", bitwise: 1 << 23 }
];

const VALID_SNOWFLAKE_REGEX = /^\d{17,20}$/;

export { USER_FLAGS, APPLICATION_FLAGS, VALID_SNOWFLAKE_REGEX };